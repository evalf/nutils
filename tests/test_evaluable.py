...
_check('norm2', lambda a: evaluable.norm2(a,2), lambda a: (a**2).sum(-2)**.5, [(4,3,4)])
_check('norm2scalar', lambda a: evaluable.norm2(a,2), lambda a: abs(a.sum(-2)), [(4,1,4)])
...
_check('inverse141', lambda a: evaluable.inverse(a+evaluable.eye(1)[None,:,None],(1,3)), lambda a: numpy.linalg.inv(a.swapaxes(-3,-2)+numpy.eye(1)).swapaxes(-3,-2), [(1,4,1)])
_check('inverse434', lambda a: evaluable.inverse(a+evaluable.eye(4)[None,:,None],(1,3)), lambda a: numpy.linalg.inv(a.swapaxes(-3,-2)+numpy.eye(4)).swapaxes(-3,-2), [(4,3,4)])
_check('inverse4422', lambda a: evaluable.inverse(a+evaluable.eye(2)[None]), lambda a: numpy.linalg.inv(a+numpy.eye(2)), [(4,4,2,2)])
...
_check('greater', lambda a,b: evaluable.greater(a,b), numpy.greater, [(4,1),(1,4)], zerograd=True)
