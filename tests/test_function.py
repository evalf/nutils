...
NNI = functools.partial(generate, real=False, zero=True, negative=False)
...
_check('dot', lambda a,b: function.dot(a,b,axes=2), lambda a,b: (a*b).sum(2), ANY(4,2,4), ANY(4,2,4))
_check('Array_dot', lambda a,b: function.Array.cast(a).dot(b,axes=2), lambda a,b: (a*b).sum(2), ANY(4,2,4), ANY(4,2,4))
