...
def main(nelems: int = 99,
    ...
    div = numpy.sqrt(function.factor(domain.integral('∇_k(u_k)^2 dV' @ ns, degree=2))) # L2 norm of velocity divergence
    ...
    for _ in steps:
        ...
        args = system.step(timestep=timestep, timetarget='t', timesteptarget='dt', historysuffix='0', arguments=args, constrain=cons, tol=1e-10)
        postprocess(args)
