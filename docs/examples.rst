...
Nutils includes a collection of example scripts that demonstrate
implementations of several solid and fluid mechanics problems. These can be
found in the ``examples/`` directory of the code repository. Note that this
