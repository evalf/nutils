...
class Topology:
    ...
    def locate(self, geom, coords, *, tol=0, eps=0, maxiter=0, arguments=None, weights=None, maxdist=None, ischeme=None, scale=None, skip_missing=False) -> Sample:
        ...
        xJ = evaluable.compile((egeom, evaluable.derivative(egeom, _point)), _plot_stats=False)
...
class TransformChainsTopology(Topology):
    ...
    def trim(self, levelset, maxrefine, ndivisions=8, name='trimmed', leveltopo=None, *, arguments=None):
        ...
        if leveltopo is None:
            ...
            levelset = evaluable.compile(levelset.lower(function.LowerArgs.for_space(self.space, (self.transforms, self.opposites), ielem_arg, coordinates)), _plot_stats=False)
                ...
                for ref, trans, ctransforms in items:
                    ...
                    while mask.any():
                        ...
                        if degree not in lowered_levelset:
                            ...
                            lowered_levelset[degree] = evaluable.compile(levelset.lower(lower_args), _plot_stats=False)
