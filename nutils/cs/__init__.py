...
from ._shape import \
    Rectangle, Circle, Ellipse, Path, \
    Box, Sphere, Cylinder, Revolved, Pipe, \
    Interval, Fused, Shapes, Orientation, generate_mesh


from ._field import \
    LocalRefinement, Ball, \
    AsField, set_background


def write(fname: str, shapes: Shapes, elemsize: AsField, order: int = 1) -> None:
    ...
    try:
        ...
        try:
            ...
            generate_mesh(gmsh.model, shapes)
            gmsh.write(fname)
        finally:
