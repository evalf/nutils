...
class Singular(Array):
    ...
    def _compile_expression(self, py_self):
...
class Range(Array):
    ...
    def _compile_expression(self, py_self, length):
...
class InRange(Array):
    ...
    def _compile_expression(self, py_self,  index, length):
...
class Polyval(Array):
    ...
    def _compile_expression(self, py_self, points, coeffs):
...
class CompressIndices(Array):
    ...
    def _compile_expression(self, py_self, indices, length):
