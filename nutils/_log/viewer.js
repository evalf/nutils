/**
 * Nutils
 * Nutils viewer, transforms a HTML document with a <pre> tag
...
function Nutils() {
    ...
    /**
     * Nutils._inpNutils
     * Checkbox to enable nutils <input>
     * @var jQuery
     */
    this._inpNutils
    ...
    /**
     * Nutils._npreload
     * Number of images preloaded before and after current image
     * @var int
     */
		this._npreload = 2;
    ...
    this.__init__ = function ( $sel ){
      ...
      // $('body').append('<script type="text/javascript" src="../../../../../nutilsrc.js"></script>');
    ...
    /**
     * Nutils.getGalleryName( url )
     * Create a gallery name from the filename
     * Strips all directories, numbers and the file extension
     *
     * ~/dot00a.png -> dot
     * ~/plot002.png -> plot
     *
